...
- [Activity by Rate Class — dual-table redesign](project_activity_by_rate_class.md) — Rediseño de charts a tablas simultáneas; granularity solo en series; hourly sin dropdown; `#range` crudo + normalización en computed
- [Mock discipline — verificar backing antes de implementar](feedback_mock_discipline.md) — AM/PM, Monthly, Custom en mocks nunca tuvieron soporte; matchear al backend, no al mock
