...
- [Branching model — la rama de pruebas es feature/staging](project_branching_model.md) — Cambió desde `develop` el 2026-09-02; `develop` ya no despliega. Regla completa en shared/feedback_branching_model.md
...
- [Feature: link al recibo del huésped (ENTREGADO)](feature_stripe_receipt_url.md) — Botón en la página del ticket → receipts.corepark.com/ticket/{ticketUuid}; sirve para los 4 gateways; gate con `payments`; incluye la carrera contra el webhook de Stripe
